...
public class GameSelectActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        GameOptionAdapter adapter = new GameOptionAdapter(Arrays.asList(
                new GameOptionAdapter.GameOption("별 터치 게임", "30초 안에 별을 많이 터치하세요!", android.R.drawable.ic_menu_myplaces, StarTapGameActivity.class),
                new GameOptionAdapter.GameOption("슬라이딩 퍼즐", "숫자를 맞춰보세요!", android.R.drawable.ic_menu_sort_by_size, SlidingPuzzleActivity.class),
                new GameOptionAdapter.GameOption("기억력 게임", "같은 그림을 찾으세요!", android.R.drawable.ic_menu_gallery, MemoryGameActivity.class),
                new GameOptionAdapter.GameOption("두들 점프", "플랫폼을 밟고 최대한 높이 올라가세요!", android.R.drawable.ic_menu_upload, DoodleJumpActivity.class),
                new GameOptionAdapter.GameOption("플래피 버드", "장애물을 피해서 최대한 멀리 날아가세요!", android.R.drawable.ic_menu_send, FlappyBirdActivity.class),
                new GameOptionAdapter.GameOption("리듬 게임", "내려오는 노트를 타이밍에 맞춰 터치하세요!", android.R.drawable.ic_media_play, RhythmGameActivity.class),
                new GameOptionAdapter.GameOption("타이핑 게임", "단어를 입력해 외계인을 물리치세요!", android.R.drawable.ic_menu_edit, AlienTypingGameActivity.class)
        ));
